  ...
  return (
    ...
    >
      ...
      >
        ...
        {allSafe ? (
          <span
            style={{ color: "#388e3c", fontWeight: "bold", fontSize: 32 }}
            title="All Safe"
          >
            &#10003;
          </span>
          ...
          <span
            style={{ color: "#d32f2f", fontWeight: "bold", fontSize: 32 }}
            title="Some Exceeded"
          >
            &#10060;
          </span>
          ...
          {data.map((chem) => (
            ...
            >
              <div style={{ marginBottom: 10 }}>
                ...
                <p style={{ margin: "8px 0", fontSize: 15, color: "#000" }}>
                  {chem.description}
                </p>
              </div>
              <div
              ...
              >
                <div>
                  <span style={{ fontSize: 13, color: "#000" }}>
                    <strong style={{ color: "#000" }}>Regulation:</strong>{" "}
                    {chem.regulation}
                  </span>
                  <br />
                  <span style={{ fontSize: 13, color: "#000" }}>
                    <strong style={{ color: "#000" }}>Threshold:</strong>{" "}
                    {chem.threshold}
                  </span>
                </div>
