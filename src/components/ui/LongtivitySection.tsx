                ...
                <div style={{ marginTop: '1rem', background: '#f6faff', borderRadius: 8, padding: '0.5rem 0' }}>
                    ...
                    {longtivityData?.reliability?.waterResistance_m && (
                        <InfoRowCard
                            ...
                            details={
                                <>
                                    Wasserresistenz: {longtivityData.reliability.waterResistance_m} m
                                </>
                            }
                            status="success"
                            iconStatus="success"
                    ...
                    {typeof longtivityData?.energy?.userReplaceableBattery === 'boolean' && (
                        <InfoRowCard
                            ...
                            status={longtivityData.energy.userReplaceableBattery ? 'success' : 'danger'}
                            iconStatus={longtivityData.energy.userReplaceableBattery ? 'success' : 'danger'}
                            style={{ marginBottom: 10 }}
                        />
                    )}
                    ...
                    {longtivityData?.repairability?.class && (
                        <InfoRowCard
                            ...
                            status={
                                ['A', 'B'].includes(longtivityData.repairability.class) ? 'success' :
                                    longtivityData.repairability.class === 'C' ? 'warning' : 'danger'
                            }
                            iconStatus={
                                ['A', 'B'].includes(longtivityData.repairability.class) ? 'success' :
                                    longtivityData.repairability.class === 'C' ? 'warning' : 'danger'
