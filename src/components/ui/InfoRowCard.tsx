...
const InfoRowCard: React.FC<InfoRowCardProps> = ({ title, details, status, iconStatus, style, children }) => (
  <Card status={status} style={{ padding: '0.8rem 1.2rem', color: '#222', ...style }}>
